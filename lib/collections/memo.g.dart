...
const MemoSchema = CollectionSchema(
  name: 'Memo',
  schema:
      '{"name":"Memo","idName":"id","properties":[{"name":"content","type":"String"},{"name":"createdAt","type":"Long"},{"name":"updatedAt","type":"Long"}],"indexes":[{"name":"updatedAt","unique":false,"properties":[{"name":"updatedAt","type":"Value","caseSensitive":false}]}],"links":[{"name":"category","target":"Category"}]}',
  idName: 'id',
